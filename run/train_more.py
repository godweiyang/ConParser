...
if __name__ == "__main__":
    ...
    trainer.set_sparse_updates(su=False)
    ...
    for epoch in itertools.count(start=config.epochs + 1):
        if config.epochs is not None and epoch > config.epochs + args.more_epochs:
            break
