...
'''
TopDown + label-LSTM + headed-W + label parameters dynamic generate
'''


class MyTopDownParser1(object):
    ...
    def parse(self, data):
        ...
        def helper(left, right, parent_state, direction):
            ...
            label_scores = MyTopDownParser1.augment(
            ...
            split_scores = MyTopDownParser1.augment(
