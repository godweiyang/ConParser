...
'''
InOrder + inorder-lstm(w/o right_trees)(input=[label_embd; lstm1(l, r)]) + span encoding=[lstm(l, r); inorder-LSTM output]
'''


class InOrderParser5(object):
    ...
    def parse(self, data):
        ...
        def predict_label(left, right, child_state):
            ...
            label_scores = InOrderParser5.augment(
        ...
        def helper(left, split, right_bound, child_state, left_trees=None, left_loss=None):
            ...
            parent_right_scores = InOrderParser5.augment(
