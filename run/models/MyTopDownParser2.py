...
'''
TopDown + label-LSTM + headed-W + label and split parameters dynamic generate
'''


class MyTopDownParser2(object):
    ...
    def parse(self, data):
        ...
        def helper(left, right, parent_state, direction):
            ...
            label_scores = MyTopDownParser2.augment(
            ...
            left_scores = get_split_scores(
                dy.concatenate_to_batch(left_encodings), parent_state, direction)
            right_scores = get_split_scores(
                dy.concatenate_to_batch(right_encodings), parent_state, direction)
            ...
            split_scores = MyTopDownParser2.augment(
