...
class InOrderParser(object):
    ...
    def parse(self, data):
        ...
        def predict_label(left, right):
            ...
            label_scores = InOrderParser.augment(
        ...
        def helper(left, split, right_bound, left_trees=None, left_loss=None):
            ...
            if left == split or left_trees is None or left_loss is None:
                ...
                left_label, left_loss = predict_label(left, split)
            ...
            parent_right_scores = InOrderParser.augment(
            ...
            label, label_loss = predict_label(left, right)
            ...
            tree, loss = helper(left, right, right_bound, childrens,
                                parent_loss + label_loss + left_loss + right_loss)
