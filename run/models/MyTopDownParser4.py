...
'''
TopDown + label-LSTM + span encoding=[lstm(l, r); label-LSTM output]
'''


class MyTopDownParser4(object):
    ...
    def parse(self, data):
        ...
        def helper(left, right, parent_state, direction):
            ...
            label_scores = MyTopDownParser4.augment(
            ...
            split_scores = MyTopDownParser4.augment(
